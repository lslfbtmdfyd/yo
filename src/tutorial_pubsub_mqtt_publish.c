...
// #define BROKER_ADDRESS_URL        "opc.mqtt://101.101.219.140:1883"

// #define BROKER_ADDRESS_URL        "opc.mqtt://101.101.218.84:1883"
...
addDataSetWriter(UA_Server *server, char *topic) {
    ...
    /* Choose the QOS Level for MQTT */
    // brokerTransportSettings.requestedDeliveryGuarantee = UA_BROKERTRANSPORTQUALITYOFSERVICE_BESTEFFORT; // qos 0
    // brokerTransportSettings.requestedDeliveryGuarantee = UA_BROKERTRANSPORTQUALITYOFSERVICE_ATLEASTONCE; // qos 1
     brokerTransportSettings.requestedDeliveryGuarantee = UA_BROKERTRANSPORTQUALITYOFSERVICE_EXACTLYONCE; //qos 2
